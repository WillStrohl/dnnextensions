...
<div id="dnnEditEntry" class="dnnForm dnnEditEntry dnnClear">
	...
	<h2 id="dnnPanel-h2FileUpload" class="dnnFormSectionHead"><a href="" class="dnnLabelExpanded"><%=this.GetLocalizedString("lblFileUpload.Text")%></a></h2>
		...
		<ol id="olFileUpload" class="dnnmedia-list">
			...
			<li id="liFileSystem" class="dnnmedia-listitem dnnmedia-localfiles" runat="server">
				<div class="dnnmedia-fieldwrapper">
					<div class="dnnFormMessage dnnFormWarning"><%=this.GetLocalizedString("lblUploadWarning.Text")%></div>
				</div>
				<div class="dnnFormItem">
				...
				<div class="dnnmedia-fieldwrapper dnnClear">
					<div id="dnnmedia-filesupport-wrapper">
						<p class="SubHead"><%=this.GetLocalizedString("HostFileTypes.Text")%>:<br /> [<a id="lnkViewFileTypes" href="#"><%=this.GetLocalizedString("lnkViewFileTypes.Text")%></a>]</p>
						<div id="divSupportedFileTypes" class="dnnmedia-hidden">
							<p class="Normal"><%=this.GetLocalizedString("lblSupportedFileTypes.Text")%></p>
							<asp:Repeater ID="rptMediaFileTypes" runat="server">
								<HeaderTemplate>
									<table id="tblMediaFileTypes" cellpadding="0" cellspacing="0" summary="<%=this.GetLocalizedString("lblSupportedFileTypes.Text")%>">
										<tr class="dnnmedia-filetype-headrow">
											<td><%=this.GetLocalizedString("tblMediaFileTypes.Header.FileType")%></td>
											<td><%=this.GetLocalizedString("tblMediaFileTypes.Header.ModuleSupport")%></td>
											<td><%=this.GetLocalizedString("tblMediaFileTypes.Header.HostSupport")%></td>
										</tr>
								</HeaderTemplate>
								<ItemTemplate>
							...
							<p id="pSupportedFileTypesLegend" class="Normal"><%=this.SupportedImage%> = <%=this.GetLocalizedString("SupportedImage.Text")%>&nbsp; <%=this.UnsupportedImage%> = <%=this.GetLocalizedString("UnsupportedImage.Text")%></p>
						</div>
					</div>
				</div>
			</li>
			<li id="liEmbed" class="dnnmedia-listitem dnnmedia-embed" runat="server">
				...
				<div class="dnnmedia-fieldwrapper">
					<div class="dnnFormMessage dnnFormInfo"><%=this.GetLocalizedString("lblEmbedSupport.Text")%></div>
				</div>
			</li>
			<li id="liOEmbed" class="dnnmedia-listitem dnnmedia-oembed" runat="server">
				<div class="dnnmedia-fieldwrapper">
					<p class="Normal"><%=this.GetLocalizedString("lblOEmbedDesc.Text")%></p>
				</div>
				<div class="dnnFormItem">
				...
				<div class="dnnmedia-fieldwrapper">
					<div class="dnnFormMessage dnnFormInfo"><%=this.GetLocalizedString("lblOEmbedSupport.Text")%></div>
				</div>
			</li>
	...
	<h2 id="dnnPanel-h2Settings" class="dnnFormSectionHead"><a href="" class=""><%=this.GetLocalizedString("BasicSettings.Text")%></a></h2>
	<fieldset id="fsSettings" class="dnnmedia-fieldset">
		<ol id="olSettings" class="dnnmedia-list">
			...
			<li class="dnnmedia-listitem">
				<p class="Normal dnnmedia-form-message"><%=this.GetLocalizedString("VideoDimsRequired.Text")%></p>
			</li>
			<li class="dnnmedia-listitem">
				<div class="dnnFormItem">
	...
	<h2 id="dnnPanel-h2VideoSettings" class="dnnFormSectionHead"><a href="" class=""><%=this.GetLocalizedString("lblVideosOnly.Text")%></a></h2>
	<fieldset id="fsVideoSettings" class="dnnmedia-fieldset">
		<ol id="olVideoSettings" class="dnnmedia-list">
			<li class="dnnmedia-listitem">
				<div class="dnnFormMessage dnnFormWarning"><%=this.GetLocalizedString("lblVideoMessage.Text")%></div>
			</li>
			<li class="dnnmedia-listitem">
				<div class="dnnFormItem">
	...
	<h2 id="dnnPanel-h2ImageSettings" class="dnnFormSectionHead"><a href="" class=""><%=this.GetLocalizedString("lblImagesOnly.Text")%></a></h2>
	...
	<h2 id="H1" class="dnnFormSectionHead"><a href="" class=""><%=this.GetLocalizedString("lblJournalIntegration.Text")%></a></h2>
...
<div id="divDnnAudit" class="dnnssStat dnnClear">
	...
	<div id="divLastUpdated" class="dnnmedia-audit dnnClear">
		<span class="SubHead"><%=this.LastUpdated%></span>
	</div>
</div>
